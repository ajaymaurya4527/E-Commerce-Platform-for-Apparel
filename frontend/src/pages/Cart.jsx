...
function Cart() {
  ...
  return (
    <div className='border-t pt-14'>
      <div className='text-2xl mb-3 prata-regular'>
      ...
      <div className='flex justify-end my-20 mr-10'>
        <div className='w-full sm:w-[450px]'>
          ...
          <div className='w-full text-end '>
            <button onClick={()=>navigate("/place-order")} className='bg-black text-white text-sm cursor-pointer my-8 px-8 py-3 rounded mr-25'>PROCEED TO CHECKOUT</button>
